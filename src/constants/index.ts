export const navlinks =[
    ...
    //{href:"/work" ,text:"work"},
    {
        ...
        href: "/services",
        sublinks: [
          { text: "Build & Design Solutions", href: "/services/build-design-solutions" },
          { text: "Site Viability Analysis", href: "/services/site-viability-analysis" },
          { text: "Design-to-Delivery Architecture", href: "/services/design-to-delivery-architecture" },
          { text: "Interior Fit-Out Expertise", href: "/services/interior-fit-outexpertise" },
          { text: "Complete Interior Solutions", href: "/services/complete-nterior-solutions" },
          { text: "Landscape Excellence Services", href: "/services/landscape-excellence-services" },
          { text: "3D Modeling & Drawing Services", href: "/services/3d-modeling-rawing-services" },
        ],
      },
...
export const cardsData = [
  ...
  export interface Project {
    ...
    slug: string;
    image: string;
    category: 'Commercial' | 'Hotel' | 'Institutes' | 'Residential' | 'Interior design';
    aspectRatio: string;
    description: string;
  ...
  export const projects: Project[] = [
    {
      ...
      team: ["Kaustubh Shevade", "Amit Chaubal","Ramachandra Sadavatti","Laxman Gundu"],
      gallery: ["/images/Project_1/abil_boulvard.jpg", "/images/Project_1/abil_boulvard1.jpg", "/images/Project_1/abil_boulvard2.jpg"],
    ...
    },
    {
      ...
      gallery: ["/images/Project_2/science_research_center1.jpg", "/images/Project_2/science_research_center2.jpg", "/images/Project_2/science_research_center3.jpg","/images/Project_2/science_research_center4.jpg","/images/Project_2/science_research_center5.jpg","/images/Project_2/science_research_center6.jpg"],
      challenge: "Creating a sustainable commercial space that maximizes natural light while maintaining energy efficiency.",
      solution: "Implemented a double-skin facade system and smart building technologies.",
      status: "Unbuilt",
    },
    {
        ...
        services: ["Architectural Design"],
        team: ["Kaustubh Shevade", "Amit Chaubal"],
        gallery: ["/images/Project_3/taxofficemazgaon1.jpg", "/images/Project_3/taxofficemazgaon2.jpg","/images/Project_3/taxofficemazgaon3.jpg","/images/Project_3/taxofficemazgaon4.jpg","/images/Project_3/taxofficemazgaon5.jpg"],
    ...
    },
    {
      ...
      services: ["Architectural Design"],
      team: ["Kaustubh Shevade", "Amit Chaubal"],
      gallery: ["/images/Project_4/shoppingcenter1.jpg", "/images/Project_4/shoppingcenter2.jpg","/images/Project_4/shoppingcenter3.jpg","/images/Project_4/shoppingcenter4.jpg"],
    ...
    },
    {
      ...
      category: "Commercial",
      aspectRatio: "4/3",
      description: "A competition project for the CII-Godrej GBC new building in Hyderabad, focusing on innovative and sustainable architectural design.",
      shortDescription: "Sustainable architectural design for CII-Godrej GBC's new building.",
      year: 2019,
      ...
      gallery: ["/images/Project_5/cii-godrej-gbc-new-building1.JPG", "/images/Project_5/cii-godrej-gbc-new-building2.JPG","/images/Project_5/cii-godrej-gbc-new-building3.JPG","/images/Project_5/cii-godrej-gbc-new-building4.JPG","/images/Project_5/cii-godrej-gbc-new-building5.JPG","/images/Project_5/cii-godrej-gbc-new-building6.JPG","/images/Project_5/cii-godrej-gbc-new-building7.JPG",],
      challenge: "Designing a cutting-edge, sustainable building concept for the competition.",
      solution: "Proposed innovative green building techniques and efficient layouts.",
      status: "Unbuilt"
    },
    {
      id: 6,
      ...
      category: "Commercial",
      aspectRatio: "4/3",
      description: "A commercial architecture project for Avante Spaces Limited in Kothrud, Pune, showcasing innovative design solutions.",
      ...
      solution: "Designed a contemporary space meeting the client's needs and aesthetic expectations.",
      status: "Completed",
    },
    {
      id: 7,
      ...
      category: "Commercial",
      aspectRatio: "4/3",
      description: "Master Plan for Technology Development Facility at BARC, Mysore, Karnataka.",
      shortDescription: "Master planning for a technology facility at BARC, Mysore.",
      year:  2011,
      client: "BARC, Mysore",
      location: "Karnataka",
      ...
      solution: "Created a comprehensive master plan meeting BARC's requirements.",
      status: "In Progress",
    },
    {
      id: 8,
      ...
      category: "Institutes",
      aspectRatio: "4/3",
      description: "Master Plan for IIT Dharwad Campus, an unbuilt competition project.",
      shortDescription: "Comprehensive master plan for the proposed IIT Dharwad Campus.",
      year: 2018,
      client: "IIT Dharwad",
    ...
    },
    {
      ...
      id: 12,
      title: "Mastre Plan and Architecture For Shri Samarth Educational & Reserch Foundation Kolhapur",
      ...
      services: ["Architecture"],
      team: ["Amit Chaubal", "Kaustubh Shevade"],
      gallery: [ "/images/Project_12/samartheducation1.jpg", "/images/Project_12/samartheducation2.jpg", "/images/Project_12/samartheducation5.jpg", "/images/Project_12/samartheducation6.jpg",],
      challenge: "Integrating modern design while maintaining warmth and livability.",
      solution: "Used natural materials and created flowing indoor-outdoor spaces.",
      status: "Completed"
    }
    ,{
      ...
      services: ["Architecture"],
      team: ["Amit Chaubal", "Kaustubh Shevade"],
      gallery: ["/images/Project_13/schoolstudy1.JPG","/images/Project_13/schoolstudy2.JPG","/images/Project_13/schoolstudy3.JPG","/images/Project_13/schoolstudy4.JPG"],
      challenge: "Integrating modern design while maintaining warmth and livability.",
      solution: "Used natural materials and created flowing indoor-outdoor spaces.",
      status: "Unbuilt"
    },
    {
      ...
      category: "Institutes",
      aspectRatio: "4/3",
      description: "A detailed feasibility study for a proposed school in Pune, focusing on sustainable design and architectural innovation.",
      ...
      team: ["Amit Chaubal", "Kaustubh Shevade"],
      gallery: ["/images/Project_14/school1.JPG","/images/Project_14/school2.JPG","/images/Project_14/school3.JPG","/images/Project_14/school4.JPG","/images/Project_14/school5.JPG","/images/Project_14/school6.JPG",],
      challenge: "Assessing the feasibility of a large-scale educational institution in Pune.",
      solution: "Developed a comprehensive plan focusing on sustainable and cost-effective architecture.",
      status: "Unbuilt"
    },
    {
      id: 15,
      ...
      category: "Commercial",
      aspectRatio: "4/3",
      description: "Feasibility study for a state-of-the-art badminton academy in Pune, focusing on sustainable sports infrastructure.",
      shortDescription: "Sustainable badminton academy feasibility study in Pune.",
      year: 2018,
      client: "Pune Developer",
      location: "Pune",
      area: "6,075 sq ft",
      ...
      challenge: "Evaluating the feasibility of creating a modern badminton academy with energy-efficient facilities.",
      solution: "Proposed an optimized layout with eco-friendly materials and sustainable designs.",
      status: "Unbuilt"
    },
    {
      id: 16,
      ...
      category: "Institutes",
      aspectRatio: "4/3",
      description: "A visionary project to establish a cutting-edge Science Research Park at IIT Bombay, fostering innovation and collaboration.",
      shortDescription: "Science Research Park initiative at IIT Bombay for innovation and collaboration.",
      year: 2016,
      client: "IIT Bombay",
      location: "Mumbai",
      area: "Not Specified",
      ...
      challenge: "Developing a research-oriented park within a bustling academic environment, adhering to space constraints.",
      solution: "Proposed a sustainable and innovative design tailored to research needs and academic synergy.",
      status: "Unbuilt"
    }
    ,{
      id: 17,
      ...
      category: "Institutes",
      aspectRatio: "4/3",
      description: "Proposed a creative and functional design for a new design college at IIT Bombay, enhancing student learning and innovation.",
      shortDescription: "Design college initiative at IIT Bombay to nurture creativity and innovation.",
      year: 2016,
      client: "IIT Bombay",
      location: "Mumbai",
      area: "Not Specified",
      ...
      challenge: "Creating a unique identity for the design college while aligning with IIT Bombay's academic culture.",
      solution: "Developed a design emphasizing modernity, functionality, and collaborative spaces for students.",
      status: "Unbuilt"
    },
    {
      id: 18,
      ...
      category: "Institutes",
      aspectRatio: "4/3",
      description: "Proposed design for ESLBARC in Surat, focusing on sustainable architecture and advanced research facilities.",
      shortDescription: "Sustainable and functional research facility design for ESLBARC, Surat.",
      year: 2013,
      client: "BARC",
      location: "Surat",
      area: "Not Specified",
      ...
      challenge: "Integrating sustainable architecture with advanced research requirements.",
      solution: "Created a concept blending modern research needs with environmentally conscious design.",
      status: "Unbuilt"
    },
    {
      id: 19,
      ...
      category: "Hotel",
      aspectRatio: "4/3",
      description: "Comprehensive master plan and architectural design for Sayaji, Kolhapur, blending hospitality needs with sustainable architecture.",
      shortDescription: "Master plan and architecture for a hospitality project in Kolhapur.",
      year: 2022,
      ...
      challenge: "Creating an efficient and aesthetically pleasing hospitality design while adhering to sustainability principles.",
      solution: "Developed a competition-winning concept integrating innovative hospitality features with modern architecture.",
      status: "Unbuilt"
    },
    {
      id: 20,
      ...
      category: "Institutes",
      aspectRatio: "4/3",
      description: "Façade design scheme for a mixed-use project by Darode Jog in Pune, emphasizing contemporary aesthetics and functionality.",
      shortDescription: "Innovative façade design for a mixed-use development in Pune.",
      year: 2014,
      client: "Darode Jog",
      location: "Pune",
      area: "",
      ...
      challenge: "Designing a façade that balances aesthetic appeal with the functional needs of a mixed-use development.",
      solution: "Crafted a unique façade scheme integrating modern design principles to enhance the building's overall character.",
      status: "Unbuilt"
    }
    ,{
      id: 21,
      ...
      aspectRatio: "4/3",
      description: "Elevation concept for a high-rise residential project in Mumbai, focusing on modern design and urban aesthetics.",
      shortDescription: "Innovative elevation concept for a high-rise residential building in Mumbai.",
      year: 2014,
      ...
      challenge: "Creating a modern and visually appealing elevation for a residential high-rise while addressing urban constraints.",
      solution: "Designed a contemporary elevation concept that balances form and functionality, enhancing the urban skyline.",
      status: "Unbuilt"
    }
,
    {
      ...
      category: "Residential",
      aspectRatio: "4/3",
      description: "Concept design for a residential high-rise in Pune, focusing on modern architecture and urban living.",
      shortDescription: "Concept design for a modern residential high-rise in Pune.",
      year: 2016,
      ...
      team: ["Amit Chaubal", "Kaustubh Shevade"],
      gallery: ["/images/img4/detail1.jpg", "/images/img4/detail2.jpg"],
      challenge: "Creating a modern residential high-rise concept in a growing urban area, balancing functionality and aesthetics.",
      solution: "Developed a concept that emphasizes efficient use of space and modern architectural design, integrating well into Pune's urban landscape.",
      status: "Unbuilt"
    },
